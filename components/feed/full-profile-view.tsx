...
import { useFeedStore, type UserProfile, type CommunityMember, type Post, type PostAuthor } from '@/lib/stores'
          ...
          <div className="relative px-4 sm:px-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-6">
              <div className="-mx-4 sm:mx-0 overflow-x-auto">
                <TabsList className="w-max min-w-full justify-start border-b rounded-none h-auto p-0 bg-transparent px-4 sm:px-0">
                <TabsTrigger 
                  value="posts" 
